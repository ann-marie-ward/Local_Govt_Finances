...
df = pd.read_excel(DATA_PREP_PATH.joinpath("uscities.xlsx"))
...
# will do more pre-processing later.  for now done in local.py


df_lat_lng = pd.read_excel(DATA_PREP_PATH.joinpath("uscities.xlsx"))


df_lat_lng = df_lat_lng[
    [
        "city",
        "city_ascii",
        "state_id",
